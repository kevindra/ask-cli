...
module.exports = class ResourcesConfig {
    ...
    getTargetDomains(profile) {
        return AskResources.getInstance().getTargetEndpoint(profile).filter(e => e !== EVENTS);
    }

    hasEventsEndpoint(profile) {
        return AskResources.getInstance().getTargetEndpoint(profile).some(e => e === EVENTS);
    }
